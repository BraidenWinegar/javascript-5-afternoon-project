...
// Once the User constructor function is created, write a prototype method for the User function. Name this method addSavedPost. It should take in 
// three parameters: id (a number), title (a string) and rating (a number). Use these parameters to create a new object and add it to the savedPosts 
// array. Make sure to name the properties the same as described previously (id, title, rating).
